...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_timeline_variant" AS ENUM('primary', 'secondary', 'accent');
  CREATE TYPE "public"."enum__pages_v_blocks_timeline_variant" AS ENUM('primary', 'secondary', 'accent');
  ...
  CREATE TABLE "pages_blocks_timeline" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"variant" "enum_pages_blocks_timeline_variant",
  ...
  CREATE TABLE "_pages_v_blocks_timeline" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"variant" "enum__pages_v_blocks_timeline_variant",
  	"default_value" numeric,
  	"_uuid" varchar,
  	"block_name" varchar
  );
